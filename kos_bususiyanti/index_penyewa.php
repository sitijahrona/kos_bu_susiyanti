...
<body>
    ...
    <h3>
        <a href="daftar_penyewa.php"><- Kembali</a><br>
        <p>Tambah Data Penyewa</p>
    </h3>
    <!-- Form untuk menambahkan data penyewa -->
    <form action="tambah_penyewa.php" method="post">
        <!-- Tabel untuk tata letak elemen form -->
        <table>
            <!-- Baris untuk input nomor penyewa -->
            <tr>
                <td>No.</td>
                <td>:</td>
                <td><input type="number" name="no" required>  </td>
            </tr>
            <!-- Baris untuk input nama penyewa -->
            <tr>
                <td>Nama Penyewa</td>
                <td>:</td>
                <td><input type="text" name="nama_penyewa" required>  </td>
            </tr>
            <!-- Baris untuk memilih jenis kelamin penyewa -->
            <tr>
                <td>Jenis Kelamin</td>
                <td>:</td>
                <td>
            ...
            <!-- Baris untuk input lantai penyewa -->
            <tr>
                <td>Lantai</td>
                <td>:</td>
                <td><input type="number" name="lantai" required> </td>
            </tr>
            <!-- Baris untuk input nomor kamar penyewa -->
            <tr>
                <td>No.Kamar</td>
                <td>:</td>
                <td><input type="text" name="no_kamar" required> </td>
            </tr>
            <!-- Baris untuk input nomor HP penyewa -->
            <tr>
                <td>No HP</td>
                <td>:</td>
